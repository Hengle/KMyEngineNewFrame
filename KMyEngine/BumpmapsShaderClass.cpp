...
bool BumpMapShaderClass::Initialize(ID3D11Device* device, HWND hwnd)
{
	...
	result = InitializeShader(device, hwnd, L"../KMyEngineData/fx/bumpmap.fx", L"../KMyEngineData/fx/bumpmap.fx");
	if(!result)
	{
		return false;
	}
...
bool BumpMapShaderClass::Render(ID3D11DeviceContext* deviceContext, int indexCount, CXMMATRIX worldMatrix, CXMMATRIX viewMatrix, 
...
bool BumpMapShaderClass::SetShaderParameters(ID3D11DeviceContext* deviceContext, CXMMATRIX worldMatrix, 
